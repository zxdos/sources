...
xst -ifn xst.scr
move dcm1_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm1_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm1_exdes.ucf dcm1_exdes
...
netgen -ofmt verilog -sim -sdf_anno false -tm dcm1_exdes -w routed.ncd routed.v
cd ..
