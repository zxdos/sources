...
xst -ifn xst.scr
move dcm_dsp_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm_dsp_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_dsp_exdes.ucf dcm_dsp_exdes

echo 'Running map'
map -timing -pr b dcm_dsp_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm dcm_dsp_exdes -w routed.ncd routed.v
cd ..
