...
module  mist_display_clk_mux_altclkctrl_uhi
	( 
	clkselect,
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //mist_display_clk_mux_altclkctrl_uhi
//VALID FILE
...
`endif
	...
	mist_display_clk_mux_altclkctrl_uhi	mist_display_clk_mux_altclkctrl_uhi_component (
				.clkselect (sub_wire2),
				.ena (sub_wire4),
				.inclk (sub_wire6),
				.outclk (sub_wire0));
