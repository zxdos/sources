...
xst -ifn xst.scr
move PLL_clock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PLL_clock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PLL_clock_exdes.ucf PLL_clock_exdes

echo 'Running map'
map -timing -pr b PLL_clock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm PLL_clock_exdes -w routed.ncd routed.v
cd ..
